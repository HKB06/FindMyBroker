...
const ArticleContent: React.FC<ArticleContentProps> = ({ content, category, tags }) => {
    ...
    return (
        <div className="relative!">
            {content && (
                <div className="flex! md:flex-row! flex-col! w-full! justify-center! gap-12!">
                    ...
                    <div className="flex flex-col gap-12 w-full! h-full!">
                        ...
                        <div className={`${categoryInfo.color} p-12 rounded-3xl shadow-md`}>
                            <h2 className="text-4xl font-bold text-white pb-8" id="recommandations-brokers">Nos recommandations de brokers pour cette catégorie</h2>
                        ...
                        <div className={`bg-white border p-12 rounded-3xl shadow-md flex flex-col gap-12 items-center`}>
                            <h2 className="text-4xl font-bold text-black w-full" id="recommandations-brokers">Sur le même sujet</h2>
                            <ListArticles category={category} numberPerPage={2} />
                            <Link href={`/blog/category/${category}`} className={`text-white text-md bg-violet-900 rounded-lg px- py-2 w-5/12 text-center`}>Voir tous les articles sur {categoryInfo.pres}</Link>
                        </div>
                    </div>
