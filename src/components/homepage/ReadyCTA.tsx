...
const ReadyCTA = () => {
  return (
    <>
      <div className='flex relative justify-center h-max w-screen md:py-20 md:mt-0 bg-gradient-to-b from-[#8B5CF6] to-[#D946EF]'>
        ...
        <div className="flex flex-col items-start md:items-center justify-start md:justify-center w-full md:w-10/12 px-12 py-24 gap-12 z-20">
          <div className="flex flex-col items-center justify-center gap-6 md:w-1/2 w-full">
            <h2 className="md:text-3xl text-2xl text-white font-bold">
              ...
              <span className='font-black bg-gradient-to-r uppercase from-[#8B5CF6] to-[#D946EF] text-transparent bg-clip-text'>
                vous&nbsp;
              </span>
              sont adaptés ?
            </h2>
          ...
          <Button className="py-6 px-8 cursor-pointer text-md md:text-lg text-white bg-[#8B5CF6] hover:bg-[#743cf4]">
            Let's go ! 🚀
          </Button>
        </div>
      </div>
