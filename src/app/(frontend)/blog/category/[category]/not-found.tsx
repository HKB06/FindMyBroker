    ...
    <>
      <div className="min-h-screen flex flex-col items-center justify-center p-4 gap-24">
        <div className="max-w-md w-full bg-white border rounded-xl overflow-hidden p-8 text-center">
          ...
          <h1 className="text-3xl font-bold text-gray-800 mb-3">Catégorie non trouvée</h1>

          <p className="text-gray-600 mb-6">
            Désolé, nous n'avons pas pu trouver la catégorie que vous recherchez.<br />
        ...
        <div className="mt-8 text-center text-gray-500 text-sm">
          <p>Vous pouvez aussi explorer nos catégories :</p>
